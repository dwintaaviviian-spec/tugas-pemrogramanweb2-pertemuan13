        ...
        <div class="card mt-3">
            <div class="card-body">
                <small class="text-muted">
                    ...
                    - Anggota terdaftar: <?php echo e($anggota->created_at->format('d M Y H:i')); ?><br />
                    - Terakhir diupdate: <?php echo e($anggota->updated_at->format('d M Y H:i')); ?><br />
                    - Lama menjadi anggota: <?php echo e($anggota->lama_anggota); ?> hari (<?php echo e(round($anggota->lama_anggota / 365, 1)); ?> tahun)
                </small>
            </div>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\semester 4\matkul pemweb2\kuliah\kuliahku\resources\views/anggota/edit.blade.php ENDPATH**/ ?>